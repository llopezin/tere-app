...
1. Como usuario, quiero poder darme de alta en el servicio, anyadir mis datos personales para poder crear facturas con ellos y reservar una cita con tipo de mi eleccion y profesional de mi eleccion.
...
Bonos
Al reservar una cita se descuenta del bono, aunque al crear cita damos opcion a no restar del bono. Si se cancela una cita se debe devolver al bono. Queremos que el profesional pueda restar una sesion del bono del paciente, esto manda una notificacion al paciente. d
